...
const About = () => {
  const teamMembers = [
    {
      name: 'Kian Brylle Enriquez',
      role: 'Project Manager',
      image: 'https://imgur.com/C8MgI3T.pngw=400',
    },
    {
      name: 'Mark Emman Lopez',
      role: 'Web Developer',
      image: 'https://imgur.com/ACD5zeO.pngw=400',
    },
    {
      name: 'Rihana Khan',
      role: 'Content Specialist',
      image: 'https://imgur.com/mlICeOn.pngw=400',
    },
    {
      name: 'Samuel De Guzman',
      role: 'Content Specialist',
      image: 'https://imgur.com/WPzEwSn.pngw=400',
    },
    {
      name: 'Lian Fianca Vinluan',
      role: 'Web Designer',
      image: 'https://imgur.com/uJK9o8t.pngw=400',
    },
    {
      name: 'John Lawrence Kenneth Mandario',
      role: 'Web Designer',
      image: 'https://imgur.com/WVTOJ32.pngw=400',
    },
    {
      name: 'Martin Ryan Malintad',
      role: 'Web Strategist',
      image: 'https://imgur.com/gxCpADl.pngw=400',
    },
    {
      name: 'Joshua Ladislao',
      role: 'Web Strategist',
      image: 'https://imgur.com/WoWuB7X.pngw=400',
    },
    {
      name: 'Ashley Nicole Baladad',
      role: 'Inbound Marketer',
      image: 'https://imgur.com/YllSgO2.pngw=400',
    },
    {
      name: 'Princes Fernandez',
      role: 'Inbound Marketer',
      image: 'https://imgur.com/EYwKthV.pngw=400',
    },
    {
      name: 'Joerwil Jedric Bandong',
      role: 'Inbound Marketer',
      image: 'https://imgur.com/MhkaDtm.pngw=400',
    },
  ];
